...
SampleOdometryModel::SampleOdometryModel(
    ...
    // the alphas
    private_nh.param<float>("sample_odometry_model_alpha_1", a1, 0.1);
    private_nh.param<float>("sample_odometry_model_alpha_2", a2, 0.1);
    private_nh.param<float>("sample_odometry_model_alpha_3", a3, 0.1);
    private_nh.param<float>("sample_odometry_model_alpha_4", a4, 0.1);
}
